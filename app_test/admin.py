...
class AdminPresentation(admin.ModelAdmin):
    list_display = ('id','name_presentation','text','link','date_publication','direction')
    list_display_link = ('id','name_presentation','text','link','photo','date_publication','direction')
    list_filter = ('date_publication',)
    search_fields = ('name_presentation','text','link','date_publication','direction')


class AdminMyForm(admin.ModelAdmin):
    list_display = ('id','your_name','select_direction')
    list_display_link = ('id','your_name','select_direction')
    list_filter = ('id',)
    search_fields = ('your_name','select_direction')
